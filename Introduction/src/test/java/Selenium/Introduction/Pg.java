...
public class Pg {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("mat-input-0")).sendKeys("5123450000000000");
        driver.findElement(By.id("mat-input-1")).sendKeys("1023");
        driver.findElement(By.id("mat-input-2")).sendKeys("123");
        driver.findElement(By.id("mat-input-3")).sendKeys("AB");
        driver.findElement(By.name("payBtn")).click();
        Thread.sleep(1000);
